...
// Type casting
// Option 1: const userInput = <HTMLInput>document.getElementById('user-input')!;
// Option 2: const userInput = <HTMLInputElement>document.getElementById('user-input')! as HTMLInputElement;
